package parserCG.visitorexample4;
...
import parserCG.astvisitors.MethodPrinter;
import parserCG.astvisitors.FieldPrinter;
import parserCG.astvisitors.ParameterPrinter;
import parserCG.astvisitors.LocalVPrinter;
import parserCG.astvisitors.PackagePrinter;
import parserCG.utilities.UtilReader;
...
public class App {
	...
	private static String myCSV = "/mnt/";
			//"/Users/matt/eclipse-workspace/testFolder/fgCSV.csv";
			//
	...
	public static void main(String[] args) {
		...
		String ownerRepo = args[0];
		myCSV += ownerRepo + "fgCSV.csv";
		...
		try (BufferedWriter writer = Files.newBufferedWriter(Paths.get(myCSV));
			...
			CSVPrinter csvPrinter = new CSVPrinter(writer, CSVFormat.
					...
					DEFAULT.withHeader("Package", "Class", "FQN", "FQN Parent", "Annotation", "Start Pos", "End Pos", "Type"));
				
				){
			//csvPrinter.flush(); 
	
					analyze(csvPrinter, ownerRepo);
	...
	public static synchronized void analyze(CSVPrinter csvPrinter, String ownerRepo) {
		//String myPath = "output.java";
		//String myPath = "/Users/matt/eclipse-workspace/testFolder/google/guava/LocalCache.java";
		String myPath = "/mnt/" + ownerRepo + "output.java";
				//"/Users/matt/eclipse-workspace/visitorexample4/output.java";
				//"/Users/matt/eclipse-workspace/testOwner/testRepo4/Car.java";
			//	"/Users/matt/eclipse-workspace/visitorexample4/output.java";
			//	"/home/mjfarrer/callgraph/output.java";
			...
			//	System.out.println(myList1.size());
				for (int i = 0; i < myList1.size(); i++) {
					...
					//int lineEnd = lineStart-1 + Integer.parseInt(newList.get(5));
						...
						csvPrinter.printRecord(myPackage, newList.get(0), newList.get(1), newList.get(2), newList.get(3), newList.get(4), newList.get(5), "Method");
				...
				for (int i = 0; i < myList2.size(); i++) {
					...
					//String name = newList.get(3);
						...
						csvPrinter.printRecord(myPackage, newList.get(0), newList.get(1), newList.get(2), newList.get(3), 0, 0, "Field");
				...
				for (int i = 0; i < myList3.size(); i++) {
					...
					int lineEnd = lineStart-1 + Integer.parseInt(newList.get(5));
						...
						csvPrinter.printRecord(myPackage, newList.get(0), newList.get(1), newList.get(2), newList.get(3), newList.get(4), newList.get(5), "Parameter");
				...
				for (int i = 0; i < myList4.size(); i++) {
					...
					int lineEnd = lineStart-1 + Integer.parseInt(newList.get(5));
						...
						csvPrinter.printRecord(myPackage, newList.get(0), newList.get(1), newList.get(2), newList.get(3), newList.get(4), newList.get(5), "Local Variable");
